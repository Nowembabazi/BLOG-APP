...
RSpec.describe 'Post show page', type: :feature do
  describe 'Post show page process' do
    before(:each) do
      @user = User.create(name: 'Nick', photo: 'https://i.imgur.com/nur.jpg', bio: 'I am a Amre\'s mother',
                          PostCounter: 2)
      @user2 = User.create(name: 'Nowe', photo: 'https://i.imgur.com/amir.jpg', bio: 'I am a Nurka\'s son',
                           PostCounter: 3)
